...
export default function WellnessBrandCaseStudy() {
  ...
  const platforms = [
    { name: "ChatGPT", citations: 18, maxCitations: 18 },
    { name: "Perplexity", citations: 12, maxCitations: 18 },
    { name: "Gemini", citations: 9, maxCitations: 18 },
    { name: "Claude", citations: 6, maxCitations: 18 },
  ];
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <MetricCard value="0 → 45" label={t("metricCitations")} animateFrom={0} animateTo={45} />
              <MetricCard value="1,203" label={t("metricPrompts")} animateFrom={0} animateTo={1203} />
              <MetricCard value="4" label={t("metricPlatforms")} animateFrom={0} animateTo={4} />
              <MetricCard value="+203%" label={t("metricTraffic")} prefix="+" animateFrom={0} animateTo={203} suffix="%" />
              <MetricCard value="2.8x" label={t("metricConversion")} />
            </div>
