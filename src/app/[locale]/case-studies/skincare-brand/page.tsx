...
export default function SkincareBrandCaseStudy() {
  ...
  const breadcrumb = buildBreadcrumbSchema([
    ...
    { name: t("heroTitle"), url: `https://akravo.com/${locale}/case-studies/skincare-brand` },
  ]);
  ...
  const platforms = [
    { name: "ChatGPT", citations: 14, maxCitations: 14 },
    { name: "Perplexity", citations: 9, maxCitations: 14 },
    { name: "Gemini", citations: 7, maxCitations: 14 },
    { name: "Claude", citations: 4, maxCitations: 14 },
  ];
        ...
        >
          ...
          >
            ...
            >
              ...
              <MetricCard
                value="847"
                label={t("metricPrompts")}
                animateFrom={0}
                animateTo={847}
              />
              <MetricCard
                value="4"
                label={t("metricPlatforms")}
                animateFrom={0}
                animateTo={4}
              />
              <MetricCard
